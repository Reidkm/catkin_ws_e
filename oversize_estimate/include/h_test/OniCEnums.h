...
{
	// Depth
	ONI_PIXEL_FORMAT_DEPTH_1_MM = 100,            //Depth data unit: 1mm
	ONI_PIXEL_FORMAT_DEPTH_100_UM = 101,          //Depth data unit: 100um (0.1mm)
	ONI_PIXEL_FORMAT_SHIFT_9_2 = 102,
	ONI_PIXEL_FORMAT_SHIFT_9_3 = 103,

	// Depth: AXon added
    ONI_PIXEL_FORMAT_DEPTH_1_3_MM = 110,         //Depth data unit: 1/3mm (0.333mm)
	ONI_PIXEL_FORMAT_DEPTH_1_2_MM = 111,		 //Depth data unit: 1/2mm (0.5mm)
