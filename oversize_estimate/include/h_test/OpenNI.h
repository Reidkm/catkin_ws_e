...
public:
	...
	*/
	...
	/**
	Equal operator. 
	@param [in] other video mode to compare
	*/
...
public:
	...
	*/
	...
	/**
	@return gap of X coordinate when cropping. 0 for no gap
	*/
	inline int getCropGx() const
	{
		return m_pFrame->cropGx;
	}
	
	/**
	@return gap of Y coordinate when cropping. 0 for no gap
	*/
	inline int getCropGy() const
	{
		return m_pFrame->cropGy;
	}
	...
	*/
	...
	{
		return m_pFrame->cropOriginWidth;
	}
	...
	*/
	...
	{
		return m_pFrame->cropOriginHeight;
	}	
	...
	@return original height
	*/
	inline int getExposureLevel() const
	{
		return m_pFrame->exposureLevel;
	}	
...
public:
	...
	*/
	...
	static float getDepthValueUnit_mm(const PixelFormat format)
	{
		return oniGetDepthValueUnit_mm((const OniPixelFormat)format);
	}
