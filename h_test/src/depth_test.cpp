...
{	
	...
	Mat rgbImageR = imread("/home/reid/Desktop/tem_folder/stereo_tem_img/img_R_0.jpg");
	...
	/*
	cout << " Rl is "<< endl << Rl << endl;
	cout << " Rr is "<< endl << Rr << endl;
	cout << " Pl is "<< endl << Pl << endl;
	cout << " Pr is "<< endl << Pr << endl;
	*/
	...
	for(;;)
	{
		...
		//cout << " img channels is " << rectifyImageL.channels() << endl;
		//cout << " img type is " << rectifyImageL.type() << endl;
		//cout << " img depth is " << rectifyImageL.depth() << endl;
		//显示在同一张图上
        	Mat canvas;
        	double sf;
		int w, h;
        ...
        */	
        ...
        // 创建SAD窗口 Trackbar
		createTrackbar("BlockSize:\n", "disparity_sgbm",&blockSize, 16, stereo_match_sgbm);
