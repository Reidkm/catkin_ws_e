...
typedef struct
{
	int dataSize;	//valid data size of "void* data", not the allocated buffer size.
	void* data;
	...
	int cropOriginWidth;		//Original width and height
	int cropOriginHeight;
...
typedef uint16_t OniIRPixel16;
typedef OniIRPixel16 OniIRPixel;
typedef uint8_t OniIRPixel8;
