...
public:
	...
	int checkFrameAllocatedSize(OniFrame* pFrame, const int size, int* pAllocatedSize = NULL)
	{
		return OniStreamServices::checkFrameAllocatedSize(pFrame, size, pAllocatedSize);
	}
};
