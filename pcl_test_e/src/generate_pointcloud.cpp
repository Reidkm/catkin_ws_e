...
int main( int argc, char** argv )
{
    ...
    if (argc < 3 )
    {
        cout << "Usage : generate_pointcloud  inputrgbimage  inputdepthimage" << endl;
        return -1;
    }
...
//     cout << "Tcw_inverse_changed = \n" << Tcw_inverse<<endl;
    ...
    Tcw_inverse  <<
        -0.0214053 , -0.0141307  , 0.999671  , -1025.67,
        0.998495 , 0.0501881 , 0.0220895  ,  308.872,
        -0.0504837   , 0.99864 , 0.0130351  , -453.388,
        0     ,    0     ,    0   ,       1;
