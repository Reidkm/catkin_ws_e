...
{
	setImageRegistrationMode_OFF_API = 1, //����ӿ�δ��ʱ��ʹ��openni API ��������
	setImageRegistrationMode_OFF_CAMERAPARAM =2,// ����ӿ�δ��ʱ��ͨ����������������룻
	setImageRegistrationMode_ON_COLOR2DEPTH =3, //�򿪶���ӿ��Զ����룻
};
...
/*	rc = depth.start();
	...
	*/
	...
	{
		std::vector<int> compression_params; //Depth���浽16λ��ѹ��PNG
